...
extern "C" {
	...
	fn ext_set_changes_trie_config(block: u64, digest_multiplier_bit: u8, digest_limit_bit: u8);
...
pub fn set_changes_trie_config(block: u64, digest_multiplier_bit: u8, digest_limit_bit: u8) {
	unsafe {
