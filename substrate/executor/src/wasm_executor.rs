...
impl_function_executor!(this: FunctionExecutor<'e, E>,
	...
	ext_set_changes_trie_config(block: u64, digest_multiplier_bit: u8, digest_limit_bit: u8) => {
		debug_trace!(target: "runtime-io", "ext_set_changes_trie_config {} {} {}",
			block, digest_multiplier_bit, digest_limit_bit);
		this.ext.set_changes_trie_config(block, digest_multiplier_bit, digest_limit_bit);
		Ok(())
	},
