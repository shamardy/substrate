...
mod tests {
	...
	fn block1() -> (Vec<u8>, Hash) {
		construct_block(
			...
			Some(hex!("205fefc042fb679cfed3f44098b45070f53c78c19f01574fa7b85a3906b9968e").into()),
			vec![BareExtrinsic {
				signed: alice(),
				index: 0,
	...
	fn block2() -> (Vec<u8>, Hash) {
		construct_block(
			2,
			block1().1,
			hex!("2b4f309c125ad368985cab4bcc64deb695da4be2a5f297c4d85968b16dea28d1").into(),
			Some(hex!("10f1d9ef21ee2bb48d20c502507c06e87c8c9a7ae7c8eec579e612ff8d7a6b5e").into()),
			vec![
				BareExtrinsic {
					signed: bob(),
					index: 0,
	...
	fn block1big() -> (Vec<u8>, Hash) {
		construct_block(
			...
			Some(hex!("140daa13db70133ebbeb41c66631573488c8024353e352b8f0578c444515bf7f").into()),
			vec![BareExtrinsic {
				signed: alice(),
				index: 0,
